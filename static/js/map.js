...
function createComparisonChart(routes) {
    ...
    // Animate
    setTimeout(() => {
        document.getElementById('comparisonChart').style.opacity = '0';
        document.getElementById('comparisonChart').style.transform = 'translateY(20px)';
        setTimeout(() => {
            document.getElementById('comparisonChart').style.transition = 'all 0.5s ease';
            document.getElementById('comparisonChart').style.opacity = '1';
            document.getElementById('comparisonChart').style.transform = 'translateY(0)';
        }, 100);
    }, 100);
}
...
document.getElementById('shareWhatsAppBtn')?.addEventListener('click', () => {
    ...
    // Fill modal
    document.getElementById('shareStartLocation').textContent = start;
    document.getElementById('shareEndLocation').textContent = end;
